...
const workExp = [
  ...
  ...jobEntry(
    "Customer Support & Manual Tester",
    "Protel Systems, Prague",
    "",
    "September 2024",
    "July 2025",
    [
...
const references = [
  new Paragraph({
    ...
    children: [
      new TextRun({
        text: "Josef Karamon – CTO at Insio  ",
        size: 18,
        font: "Calibri",
        color: DARK_GRAY,
      }),
  ...
  new Paragraph({
    ...
    children: [
      new TextRun({
        text: "Hedvika Truneckova – CEO at Protel  ",
        size: 18,
        font: "Calibri",
        color: DARK_GRAY,
      }),
      new TextRun({
        text: "hedvika.truneckova@protelsystems.cz",
        size: 18,
        font: "Calibri",
        color: BLUE,
      }),
...
// Interests
const interests = [skillItem("Computer Games"), skillItem("Team sport"), skillItem("Travels")];
